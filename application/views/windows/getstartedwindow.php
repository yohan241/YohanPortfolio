    ...
    <div class="mainwindowcontent homeframecontent">
        <div class="container-fluid vh-50 d-flex justify-content-center align-items-center">
            <div class="desktop-grid d-flex flex-wrap justify-content-center gap-4">
                ...
                <img onmouseover="playSound('clickSound')" src="<?= base_url(); ?>assets/images/information.png" alt="About">
                <span>About Me</span>
                </div>
                <div class="desktop-icon" onclick="loadWindowByName('work', 'workwindow')">
                <img onmouseover="playSound('clickSound')" src="<?= base_url(); ?>assets/images/archive.png" alt="Projects">
                <span>Work</span>
                </div>
                <div class="desktop-icon" onclick="loadWindowByName('games', 'gameswindow')">
                <img onmouseover="playSound('clickSound')" src="<?= base_url(); ?>assets/images/launch.png" alt="Games">
                <span>Games</span>
                </div>
                <div class="desktop-icon" onclick="loadWindowByName('contacts', 'contactswindow')">
                <img onmouseover="playSound('clickSound')" src="<?= base_url(); ?>assets/images/email.png" alt="Contact Me">
